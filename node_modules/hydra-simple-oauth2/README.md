...
```bash
npm install --save hydra-simple-oauth2
```
...
const { ClientCredentials, ResourceOwnerPassword, AuthorizationCode } = require('hydra-simple-oauth2');
```
